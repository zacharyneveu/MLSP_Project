...
% Zach Added packages
\usepackage{acronym}
\newacro{K-SVD}{K-Singular Value Decomposition}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\begin{abstract}
This work discusses a method to perform piano music transcription using \ac{K-SVD}
\end{abstract}
%
\begin{keywords}
...
them and if you have any questions, direct them to the course responsible.
